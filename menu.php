...
<body style="background-image: url('http://aaronmillan.com/static/data1.jpeg');background-size:cover;
...
<div class="text-center">
    <span class="text  text-info" >portfolio</span>
</div>
...
-->
    ...
    <a href=" http://localhost/CRUD-ecommerce-master/index.php" class="button" style="width: 15%;margin-left: 40%">CRUD e commerce</a>
    <a href=" http://localhost/Projet_3B-master/listeAmpoule.php" class="button mt-5" style="width: 15%;margin-left: 40%">CRUD ampoule</a>
</body>
</html>
